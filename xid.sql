...
CREATE SEQUENCE xid_serial MINVALUE 1 MAXVALUE 16777215 CYCLE ;

SELECT setval('xid_serial', ( random() * ((255<<16) + (255<<8) + 255))::INT);
...
BEGIN
    ...
    return ARRAY[
            ((_dec[ascii(substring(_xid,1))]<<3) | (_dec[ascii(substring(_xid, 2))]>>2)) % 256,
            ((_dec[ascii(substring(_xid,2))]<<6) | (_dec[ascii(substring(_xid,3))]<<1) | (_dec[ascii(substring(_xid,4))]>>4)) % 256,
            ((_dec[ascii(substring(_xid,4))]<<4) | (_dec[ascii(substring(_xid,5))]>>1)) % 256,
            ((_dec[ascii(substring(_xid,5))]<<7) | (_dec[ascii(substring(_xid,6))]<<2) | (_dec[ascii(substring(_xid,7))]>>3)) % 256,
            ((_dec[ascii(substring(_xid,7))]<<5) | (_dec[ascii(substring(_xid,8))])) % 256,
            ((_dec[ascii(substring(_xid,9))]<<3) | (_dec[ascii(substring(_xid,10))]>>2)) % 256,
            ((_dec[ascii(substring(_xid,10))]<<6) | (_dec[ascii(substring(_xid,11))]<<1) | (_dec[ascii(substring(_xid,12))]>>4)) % 256,
            ((_dec[ascii(substring(_xid,12))]<<4) | (_dec[ascii(substring(_xid,13))]>>1)) % 256,
            ((_dec[ascii(substring(_xid,13))]<<7) | (_dec[ascii(substring(_xid,14))]<<2) | (_dec[ascii(substring(_xid,15))]>>3)) % 256,
            ((_dec[ascii(substring(_xid,15))]<<5) | (_dec[ascii(substring(_xid,16))])) % 256,
            ((_dec[ascii(substring(_xid,17))]<<3) | (_dec[ascii(substring(_xid,18))]>>2)) % 256,
            ((_dec[ascii(substring(_xid,18))]<<6) | (_dec[ascii(substring(_xid,19))]<<1) | (_dec[ascii(substring(_xid,20))]>>4)) % 256
        ];
END;
$$;
...
BEGIN
    ...
    _bytes := int8send(EXTRACT(epoch FROM _at)::BIGINT);
